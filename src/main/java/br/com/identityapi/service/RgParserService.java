...
public class RgParserService {
    ...
    public DocumentoRgResponse parsear(String texto) {
        ...
        return DocumentoRgResponse.of(
                extrairNome(upper), extrairCpf(upper), extrairDataNascimento(upper),
                extrairNaturalidade(upper), extrairPai(upper), extrairMae(upper),
                extrairOrgaoExpedidor(upper), extrairRg(upper),
                extrairDataExpedicao(upper), texto);
    }

    public DocumentoMenorResponse parsearMenor(String texto) {
        String upper = texto.toUpperCase();
        return DocumentoMenorResponse.of(
                extrairNome(upper), extrairCpf(upper), extrairDataNascimento(upper),
                extrairNaturalidade(upper), extrairPai(upper), extrairMae(upper),
                extrairOrgaoExpedidor(upper), extrairRg(upper),
                extrairDataExpedicao(upper), texto);
